  ...
  return (
    <div className='w-full bg-gradient-to-r from-red-600 via-orange-500 to-red-600 py-3 relative overflow-hidden'>
            <div className='container mx-auto px-4 '>
                <div className='flex flex-col md:flex-row items-center justify-center gap-2 sm:gap-6 text-white'>
                    <div className='flex items-center gap-2'>
                        ...
                        <span className='font-bold text-yellow animate-pulse'>
                            UP TO 95% OFF!
                        </span>

                    </div>
                    <button className='bg-white text-red-600 px-4 py-1 rounded-full font-bold text-sm hover:bg-yellow-100 shadow-lg transition-colors'
                    onClick={() => {router.push('/')}}>
